package com.rtsp.rtspclient.vlc;
...
public class VlcVideoLibrary implements MediaPlayer.EventListener {
    ...
    public void onEvent(MediaPlayer.Event event) {
        Log.d("VlcVideoLibEvent", "onEvent: "+event.type);
        switch (event.type) {
            case MediaPlayer.Event.Playing:
                if(vlcListener != null)vlcListener.onComplete();
                break;
            case MediaPlayer.Event.EncounteredError:
                if(vlcListener != null)vlcListener.onError();
                break;
            case MediaPlayer.Event.Buffering:
                if(vlcListener != null)vlcListener.onBuffering(event);
                break;
            case MediaPlayer.Event.Stopped:
                if(vlcListener != null) vlcListener.onDisConnected();
                break;
            default:
                break;
        }
